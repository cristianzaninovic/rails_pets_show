...
ActiveRecord::Schema[7.0].define(version: 2023_09_14_232135) do
  ...
  create_table "pets_users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_pets_users_on_email", unique: true
    t.index ["reset_password_token"], name: "index_pets_users_on_reset_password_token", unique: true
  end
